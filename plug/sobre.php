  ...
  <div class="col-md-3">
      <div class="rounded-circle">
        <a href="https://www.instagram.com/depaulin_eric/" target="_blank">
          <img src="images/ericredondo.png" alt="1" style="width:80%">
          
          <h5 class="text-align">Eric de Paula</h5>
          
        </a><p class="text-align">Desenvolvedor e Programador back-end</p>
      </div>
    </div>
    <div class="col-md-3">
      <div class="rounded-circle">
         <a href="https://www.instagram.com/vinesaquelli/" target="_blank">
          <img src="images/saquellifotonova.png" alt="2" style="width:80%">
          
          <h5 class="text-align">Vinicius Saquelli</h5>
          
        </a><p class="text-align">Analista de Sistemas</p>
      </div>
    </div>
    <div class="col-md-3">
      <div class="rounded-circle">
        <a href="#" target="_blank">
          <img src="images/pintoredondo.png" alt="3" style="width:80%">
          
          <h5 class="text-align">Matheus Pinto</h5>
          
        </a><p class="text-align">Designer</p>
      </div>
    </div>
     <div class="col-md-3">
      <div class="rounded-circle">
        <a href="https://www.instagram.com//" target="_blank">
          <img src="images/eduredondo.png" alt="4" style="width:80%">
          
          <h5 class="text-align">Eduardo Laffot</h5>
          
        </a><p class="text-align">Responsável pela documentação</p>
      </div>
    </div>
</body>
</html>